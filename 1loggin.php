...
<link href="estilos.css" type="text/css" rel="stylesheet" />
    <title>Loggin | Polideportivo</title>
      ...
      <div class="FiLa">
        <div class="columna4">
          <img class="img-circle" src="" alt="Generic placeholder image" style="width: 1px; height: 1px;">
		   <img class="img-circle" src="Imagenes/chinaz1.png" alt="Generic placeholder image" style="width: 102px; height: 140px;">
	   ...
	   <div class="columna5">
          <h2>Loggin</h2>
		  <p>Ingrese numero de cuenta y contraseña.</p>
		  
		  <form action="1loggin.php" method="post">
                    <ul>
                        <li>Número de cuenta
						   <br><input type="text" id="UserName" name="UserName" placeholder="Numero de cuenta" required="true">
                        </li>
                        <li>Contraseña
                            <br><input type="password" id="Password" name="Password" placeholder="Contraseña" required="true">
                        </li>                     
                        <li><input type="submit" id="Login" value="Entrar"></li>					   
                    </ul>
					
			
					</form>
					<div id="msj"></div>
					<div id="msj2"></div><br><br>
		...
		<br><br><br>
		 <p>
            <a href="1RestablecerContrasena.php">Olvide mi contraseña.</a>
        </p>
		<br><br><br>
		 <p>
            <a href="1CambiarContrasena.php">Cambiar contraseña.</a>
        </p>
		  </div><!-- /.col-lg-4 -->
