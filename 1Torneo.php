          ...
          <div class="contenedor">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active" ><a href="1Torneo.php">Torneo</a></li>
    ...
    <div id="myCarousel" class="carousel slide mmm2" data-ride="carousel">        
      ...
      <div class="FiLa">
	   ...
	   <div class="FiLa featurette">
        <div class="columna7">
         ...
         llenando al menos 12 participantes con sus respectivos datos,
	  ...
	  <form action="1Torneo.php" method="post" class="tbb" id="tbb">
		 ...
		 <table class="tb2" id="tb2" style="width:6%; border-spacing:1; ">
            ...
            <tr>
			  <td> 1 </td>
			  <td> <input type="text" name="nombre1" id="nombre1" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta1" id="cuenta1" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono1" id="telefono1" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo1" id="correo1" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera1" id="Carrera1" placeholder="">	
            ...
            <tr>
			  <td> 2 </td>
			  <td> <input type="text" name="nombre2" id="nombre2" placeholder="Nombre" required="true" </td>
			  <td> <input type="text" name="cuenta2" id="cuenta2" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono2" id="telefono2" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo2" id="correo2" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera2" id="Carrera2" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 3 </td>
			  <td> <input type="text" name="nombre3" id="nombre3" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta3" id="cuenta3" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono3" id="telefono3" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo3" id="correo3" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera3" id="Carrera3" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 4 </td>
			  <td> <input type="text" name="nombre4" id="nombre4" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta4" id="cuenta4" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono4" id="telefono4" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo4" id="correo4" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera4" id="Carrera4" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 5 </td>
			  <td> <input type="text" name="nombre5" id="nombre5" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta5" id="cuenta5" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono5" id="telefono5" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo5" id="correo5" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera5" id="Carrera5" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 6 </td>
			  <td> <input type="text" name="nombre6" id="nombre6" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta6" id="cuenta6" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono6" id="telefono6" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo6" id="correo6" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera6" id="Carrera6" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 7 </td>
			  <td> <input type="text" name="nombre7" id="nombre7" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta7" id="cuenta7" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono7" id="telefono7" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo7" id="correo7" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera7" id="Carrera7" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 8 </td>
			  <td> <input type="text" name="nombre8" id="nombre8" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta8" id="cuenta8" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono8" id="telefono8" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo8" id="correo8" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera8" id="Carrera8" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 9 </td>
			  <td> <input type="text" name="nombre9" id="nombre9" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta9" id="cuenta9" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono9" id="telefono9" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo9" id="correo9" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera9" id="Carrera9" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 10 </td>
			  <td> <input type="text" name="nombre10" id="nombre10" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta10" id="cuenta10" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono10" id="telefono10" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo10" id="correo10" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera10" id="Carrera10" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 11 </td>
			  <td> <input type="text" name="nombre11" id="nombre11" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta11" id="cuenta11" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono11" id="telefono11" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo11" id="correo11" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera11" id="Carrera11" placeholder="">						
				  <option value="">Seleccione Opción</option>
				  <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
            ...
            <tr>
			  <td> 12 </td>
			  <td> <input type="text" name="nombre12" id="nombre12" placeholder="Nombre" required="true"> </td>
			  <td> <input type="text" name="cuenta12" id="cuenta12" placeholder="N0. Cuenta" required="true"> </td>
			  <td> <input type="text" name="telefono12" id="telefono12" placeholder="Telefono" required="true"> </td>
			  <td> <input type="text" name="correo12" id="correo12" placeholder="Correo" required="true"> </td>
			  <td> <select required name="Carrera12" id="Carrera12" placeholder="">						
				   <option value="">Seleccione Opción</option>
				   <option value="Ing. en Informática">Ing. en Informática</option>
				   <option value="Lic. en Administración de Empresas">Lic. en Administración de Empresas</option>
                   <option value="Lic. en Turismo">Lic. en Turismo</option>
