...
<link href="estilos.css" type="text/css" rel="stylesheet" />
    <title>Restablecer Contraseña | Polideportivo</title>
...
<article class="contact">
   ...
   <section class="contact">
        ...
        Ingrese numero de cuenta y correo.
					...
					<form action="1RestablecerContrasena.php" method="post">
                    <ol>
                        <li>
                        ...
                        <li>
                            Correo
                            <br><input type="password" id="correo" name="correo" placeholder="Correo" required="true">@unitec.edu
                        </li>
...
$msj="Por este mensaje le avisamos que solicito un cambio de contraseña<br>
	  ...
	  <br><a href='http://appletenhtml.comule.com/polideportivo/1CambiarContrasena.php'>Cambiar contraseña</a>
	  <br><br><a href='http://appletenhtml.comule.com/polideportivo/1loggin.php'>Ya puedes iniciar sesion</a>
